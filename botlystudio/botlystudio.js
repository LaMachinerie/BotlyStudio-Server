...
BotlyStudio.initialiseIdeButtons = function() {
  document.getElementById('button_ide_left').title = "Effacer";
  document.getElementById('button_ide_middle').title = "Code";
  document.getElementById('button_ide_large').title = "Executer";
};
